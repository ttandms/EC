...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'detail' => ['type' => 'string', 'length' => 128, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'img_path' => ['type' => 'string', 'length' => 64, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'path?', 'precision' => null, 'fixed' => null],
        ...
        'delete_flg' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => '0', 'comment' => '1:削除', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'price' => 1,
                'stock' => 1,
                'update_time' => '2018-12-16 06:58:26',
                'delete_flg' => 1,
                'category_id' => 1
            ],
        ];
